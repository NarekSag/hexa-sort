...
namespace _Project.Scripts.Runtime.Gameplay.Presentation.Grid.Slot {
    /// <summary>
    /// Handles visual highlighting for hex slots.
    /// Follows Single Responsibility Principle - only manages highlight visuals.
    /// Optimized for performance with material caching and property checks.
    /// </summary>
